 ...
 *
 * Este componente representa la línea de comando estilo Kali Linux.
...
export default function TerminalPrompt({
  ...
  return (
    <div class="font-mono text-sm leading-tight">
       ...
       *
       * Se replica el estilo del prompt de Kali: 
       * ┌──(kali㉿portfolio)-[~] 
       * 
...
*/}
      <div class="flex items-center">
         ...
         */}
        {command && (
          <span class="ml-2 text-[var(--white-soft)]">{command}</span>
        )}
